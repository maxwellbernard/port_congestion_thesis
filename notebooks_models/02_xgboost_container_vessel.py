...
def load_and_preprocess(
    ...
    """Load container CSV, parse dates, filter ports, encode port."""
...
def train_xgboost(
    ...
    Args:
        ...
        ports: Port names for per-port eval.
...
for target in TARGETS:
    ...
    print(f"\n{'=' * 80}")
    print(f"XGBOOST SUMMARY — {horizon_label}")
    print(f"{'=' * 80}")
...
print("\n" + "=" * 92)
print("XGBOOST GRAND SUMMARY — ALL HORIZONS")
print("=" * 92)
